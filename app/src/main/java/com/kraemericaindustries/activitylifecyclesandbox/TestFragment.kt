...
import com.kraemericaindustries.activitylifecyclesandbox.databinding.FragmentTestBinding
...
class TestFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textViewFragmentText.text = "We have made it into our new fragment.  This is the inViewCreated() code."
